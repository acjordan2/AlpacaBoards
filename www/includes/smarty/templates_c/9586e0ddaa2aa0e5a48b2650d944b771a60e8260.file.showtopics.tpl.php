<?php /* Smarty version Smarty-3.1.7, created on 2013-04-22 12:05:26
         compiled from "/var/www/Sper.gs/www/templates/default/showtopics.tpl" */ ?>
<?php /*%%SmartyHeaderCode:834182080510dafb15e8b52-01789872%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9586e0ddaa2aa0e5a48b2650d944b771a60e8260' => 
    array (
      0 => '/var/www/Sper.gs/www/templates/default/showtopics.tpl',
      1 => 1366657522,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '834182080510dafb15e8b52-01789872',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_510dafb18b4d4',
  'variables' => 
  array (
    'board_title' => 0,
    'current_page' => 0,
...
<?php if ($_valid && !is_callable('content_510dafb18b4d4')) {function content_510dafb18b4d4($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/Sper.gs/www/includes/smarty/plugins/modifier.date_format.php';
...
<?php } ?>
	...
	<div class="infobar">
		Page: <?php $_smarty_tpl->tpl_vars["i"] = new Smarty_variable(1, null, 0);?>
		<?php while ($_smarty_tpl->tpl_vars['i']->value<=$_smarty_tpl->tpl_vars['page_count']->value){?>
	      		<?php if ($_smarty_tpl->tpl_vars['i']->value==$_smarty_tpl->tpl_vars['current_page']->value){?><?php echo $_smarty_tpl->tpl_vars['i']->value;?>

				<?php if ($_smarty_tpl->tpl_vars['i']->value<$_smarty_tpl->tpl_vars['page_count']->value){?>|<?php }?>
				<?php }else{ ?>
					<a href="./showtopics.php?board=42&amp;page=<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
