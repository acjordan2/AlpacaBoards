{include file="header.tpl"}
            <h1>Related Images for <a href="#">{$filename}</a></h1>
            ...
            {foreach from=$images key=header item=img}
                <div class="grid_block">
                    <a href="./usercontent/i/n/{$img.sha1_sum}/{$img.filename_url}"><img src="./usercontent/i/t/{$img.sha1_sum}/{$img.filename_url}.jpg" /></a><br/>
                    <div class="block_desc">
                        <a style="float: left;" href="./img.php?hash=f818de60196ad15c888b7f2140a77744">{$img.filename}</a>
